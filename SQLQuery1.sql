...
insert into Products values('One Plus 6', 8429, '2018-7-1', 'InStock', 1, 1, 1)
insert into Products values('Red MI Note', 27000, '2016-6-15', 'OutOfStock', 2, 1, 1)
insert into Products values('Sony XPeria', 99999, '2018-6-10', 'InStock', 1, 2, 1)
insert into Products values('Google Nexus', 34700, '2018-3-4', 'InStock', 1, 4, 1)
insert into Products values('One Plus 9', 67000, '2018-7-19', 'InStock', 2, 3, 1)
go
...
delete from Products where Price=null